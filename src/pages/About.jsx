...
//             promoting holistic growth through a balanced education system that
...
//         offering day school from Kindergarten through 10. The school operates in
//         three earthquake-resistant academic and administrative blocks spread
//         over 23 ropanis of land. Our advanced infrastructure includes modern
//         classrooms and facilities designed to provide a safe, technologically
//         advanced learning environment that meets international standards.
//       </p>
//       <p className="mission-p">
...
//         environments, encouraging students to engage deeply during their study
//         hours.
//       </p>
//     </div>
...
//           Earthquake-resistant buildings and modern facilities ensure a safe and
...
//           Focus on physical, mental, and intellectual growth through our
//           innovative Learning by Practice Reinforcement Approach (LPRA).
//         </li>
//         <li className="mb-3">
//           <i className="fas fa-check-square me-2 text-danger" />
//           <strong>Experienced Faculty: </strong>
//           Dedicated and skilled educators committed to nurturing each child's
//           potential.
//         </li>
//         <li className="mb-3">
//           <i className="fas fa-check-square me-2 text-danger" />
...
//         Learning-Reinforcement-Practice-Application (LRPA) approach, Aksharaa
//         strives to achieve integrated child development.
//       </p>
//     </div>
//   </div>
// );
