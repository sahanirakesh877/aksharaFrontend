...
const items = MunImg.map((img, index) => (
  <div className="px-1" key={index}  >
      <img src={img} alt={`Brand ${index + 1}`} className="img-fluid rounded " style={{
      width: '100%',
      height: 'auto',
      objectFit: 'cover', 
    }} />
        ...
        <div className="container py-5">
          ...
          <AliceCarousel
            ...
            <p className="about-p">
              ...
              representatives of various countries. <br />
          ...
          <section id="activities" className="my-5">
            <div className="row d-flex justify-content-between  align-items-start">
              ...
              <div className="col-md-6">
                ...
                <ul>
                  <li>
                    (Pic of book)MUN helps to ensure a clear concept on diverse
                    topics, diplomacy, & engaging committee sessions to provide
                    an educational experience to delegates.
                  </li>
                  <li>
                    (pic of Mic)Delegates improve their public speaking skills,
                    overcome their massphobia and increase their confidence
                    while speaking and making conversations.
                  </li>
                  <li>
                    (pic of Magnifying glass) The goal is to enhance research,
                    presentation & facilitation skills and help to explore
                    creative solutions to complex challenges to delegates.{" "}
                  </li>
                </ul>
              </div>
